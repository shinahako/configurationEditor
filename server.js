...
/*  switch (req.query.url) {
    case "http://etlexporter.vip.qa.ebay.com/v1/configuration/getActive?etlName=Comics%20US":
      ...
      break;
    case "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getAll":
    case "http://etlexporter.vip.qa.ebay.com/v1/validators/getAll":
      console.log("2");
      res.send({
        "responseStatus": "SUCCESS",
        "entity": [
          {
            ...
            "links": [
              {
                "rel": "Default Settings",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettings?enricherName=MeasurementConverterEnricher"
              },
              {
                "rel": "Default Settings JSON Schema",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettingsSchema?enricherName=MeasurementConverterEnricher"
              }
            ]
          },
          {
            ...
            "links": [
              {
                "rel": "Default Settings",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettings?enricherName=AggregationKeyProductEnricher"
              },
              {
                "rel": "Default Settings JSON Schema",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettingsSchema?enricherName=AggregationKeyProductEnricher"
              }
            ]
          },
          {
          ...
          },
          {
            ...
            "links": [
              {
                "rel": "Default Settings",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettings?enricherName=ValueSplitEnricher"
              },
              {
                "rel": "Default Settings JSON Schema",
                "href": "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettingsSchema?enricherName=ValueSplitEnricher"
              }
            ]
          },
          {
      ...
      break;
    case "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettings?enricherName=MeasurementConverterEnricher":
      console.log("3");
      res.send({entity:{
        "firstName": "Chuck",
        "lastName": "Norris",
      ...
      break;
    case "http://etlexporter.vip.qa.ebay.com/v1/enrichers/getDefaultSettingsSchema?enricherName=MeasurementConverterEnricher":
      console.log("4");
      res.send({entity:{
